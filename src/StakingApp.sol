...
contract StakingApp is Ownable {
    ...
    receive() external payable onlyOwner {
        //Funcion para recibir ether en el contrato //El receive puede tener lógica
        emit EtherSent(msg.value);
    }

    function changeStakingPeriod(uint256 newStakingPeriod_) external onlyOwner {
        //Colocamos el modificador onlyOwner para que solo el dueño del contrato pueda cambiar el periodo de staking, este modificador viene de la libreria OpenZeppelin
